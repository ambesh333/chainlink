...
function BlockNodeComponent({ data, type, selected }: NodeProps) {
    ...
    return (
        <div
            ...
            className="rounded-xl border px-4 py-3 min-w-[190px] backdrop-blur-xl transition-all duration-200 relative overflow-visible"
        >
            ...
            {showInputHandle && (
                <Handle
                    ...
                    className="!w-3 !h-3 !border-2 !rounded-full !-top-[6px]"
                ...
                isCondition ? (
                    <>
                        <Handle
                            ...
                            id="true"
                            className="!w-3 !h-3 !border-2 !rounded-full !-bottom-[6px]"
                            style={{ background: '#34d399', borderColor: '#34d39980', left: '35%' }}
                        />
                        <Handle
                            type="source"
                            position={Position.Bottom}
                            id="false"
                            className="!w-3 !h-3 !border-2 !rounded-full !-bottom-[6px]"
                            style={{ background: '#f87171', borderColor: '#f8717180', left: '65%' }}
                        />
                    </>
                ) : (
                    <Handle
