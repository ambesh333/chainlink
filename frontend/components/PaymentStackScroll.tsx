        ...
        return (
            <div className="flex items-center justify-center h-screen bg-black text-white">
                <div className="flex flex-col items-center gap-4">
                    <div className="w-12 h-12 border-t-2 border-[#4C8BF5] rounded-full animate-spin"></div>
    ...
    return (
        <div ref={containerRef} className="relative h-[400vh] bg-black">
            <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
                ...
                >
                    <div className="backdrop-blur-md bg-gradient-to-br from-[#0f1a2e]/80 to-[#0a1020]/60 border border-[#1a2a4e]/40 rounded-3xl p-8 shadow-2xl">
