            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="text-center mb-20">
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                        Built for the <span className="bg-gradient-to-r from-[#375BD2] to-[#4C8BF5] bg-clip-text text-transparent">AI Economy</span>
                    </h2>
                            ...
                            >
                                ...
                                <div className="flex-1 w-full">
                                    <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-[#375BD2]/10">
                                            ...
                                            {feature.videoSrc ? (
                                                ...
                                                <div className="absolute inset-0 flex items-center justify-center">
                                                    <div className="text-center p-8">
                                                        <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-[#375BD2]/20 flex items-center justify-center">
                                                            <svg className="w-8 h-8 text-[#375BD2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        {/* Glow effect */}
                                        <div className={`absolute -inset-1 bg-gradient-to-r from-[#375BD2]/20 to-transparent blur-xl -z-10 ${isReversed ? 'rotate-180' : ''}`} />
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 w-full">
                                    <div className={`${isReversed ? 'md:text-right' : ''}`}>
                                        <span className="text-[#375BD2] text-sm font-medium uppercase tracking-wider">
                                            {feature.subtitle}
                                        </span>
                                        ...
                                        <div className={`flex flex-wrap gap-3 mt-6 ${isReversed ? 'md:justify-end' : ''}`}>
                                            {['Privacy-first', 'Real-time', 'Oracle-powered'].map((tag) => (
                                                <span
                                                    key={tag}
                                                    className="px-3 py-1 text-xs font-medium text-[#4C8BF5] bg-[#375BD2]/10 rounded-full border border-[#375BD2]/20"
                                                >
                                                    {tag}
                                                </span>
                                            ))}
