...
var DISPUTE_RAISED_EVENT_SIG = "0x255562e4a5019b56d8cea1a092a988f24c5482ce33b57586784208be247693c1";
...
var onDisputeRaised = (runtime2, triggerOutput) => {
  ...
  runtime2.log(`DisputeRaised detected`);
  ...
  try {
    ...
    runtime2.log(`AI Verdict: payMerchant=${payMerchant}`);
    runtime2.log(`AI Confidence: ${aiConfidence}`);
    runtime2.log(`AI Reasoning: ${aiReasoning}`);
  } catch (err) {
    runtime2.log("AI backend call failed — defaulting to refund agent");
  }
  const reportData = encodeAbiParameters([{ type: "bytes32" }, { type: "bool" }], [escrowKey, payMerchant]);
  runtime2.log(`Generating signed report → escrowKey=${escrowKey}, payMerchant=${payMerchant}`);
